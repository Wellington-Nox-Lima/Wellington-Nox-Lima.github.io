...
export function Contact() {
  ...
  return (
    <section id="contato" className="section-shell">
      <div className="panel-card p-5 sm:p-10">
        ...
        <div className="mt-8 grid gap-3 sm:mt-10 sm:gap-4 md:grid-cols-3">
          <a
            ...
            className="rounded-2xl border border-white/10 bg-black/10 p-4 transition hover:border-white/20 hover:bg-white/[0.03] sm:p-5"
            aria-label={`Enviar email para ${person.email}`}
          >
            <Mail className="h-5 w-5 text-accentSoft" />
            <p className="mt-3 text-sm uppercase tracking-[0.16em] text-muted sm:mt-4 sm:tracking-[0.18em]">Email</p>
          </a>
          ...
          >
            ...
            <p className="mt-3 text-sm uppercase tracking-[0.16em] text-muted sm:mt-4 sm:tracking-[0.18em]">GitHub</p>
          </a>
          ...
          >
            ...
            <p className="mt-3 text-sm uppercase tracking-[0.16em] text-muted sm:mt-4 sm:tracking-[0.18em]">LinkedIn</p>
          </a>
        </div>
      </div>
    </section>
